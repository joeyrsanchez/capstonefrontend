...
class CreateIraRegular extends Component {
  constructor(props) {
    super(props);
    this.state = {
      balance: "",
  ...
  create = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:3000/user/iraregular", this.state, {
        headers: {
        ...
        <Container fluid>
          <Row>
            <Col sm="12" md={{ size: 4, offset: 4 }}>
              <h2>Create an IRA Regular account.</h2>
              <Form onSubmit={this.create}>
                <FormGroup controlId="forBalance">
                  <Label for="balance">New Ira Regular Balance</Label>
                  <Input
                    type="text"
...
export default CreateIraRegular;
